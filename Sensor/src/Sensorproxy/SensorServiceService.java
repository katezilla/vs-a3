 ...
 * 
 */
@WebServiceClient(name = "SensorServiceService", targetNamespace = "http://hawsensor/", wsdlLocation = "http://localhost:9999/Sensor?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SENSORSERVICESERVICE_QNAME = new QName("http://hawsensor/", "SensorServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9999/Sensor?wsdl");
    ...
    public SensorService getSensorServicePort() {
        return super.getPort(new QName("http://hawsensor/", "SensorServicePort"), SensorService.class);
    }
    ...
    public SensorService getSensorServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://hawsensor/", "SensorServicePort"), SensorService.class, features);
    }
